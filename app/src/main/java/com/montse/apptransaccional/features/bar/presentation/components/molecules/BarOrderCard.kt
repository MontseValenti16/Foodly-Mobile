package com.montse.apptransaccional.features.bar.presentation.components.molecules
...
fun BarOrderCard(
    ...
    val backgroundColor = if (isPending) Color(0xFFFFF3E0) else Color(0xFFE3F2FD)
